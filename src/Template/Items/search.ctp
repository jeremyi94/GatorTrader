...
<div class="thumbnail"><?= '<img src="../webroot/img/items/thumbnails/' . $result['id'] . 'a.jpg" alt="' .$result['description']. '"/>' ?></div>
<?php endif; ?>
<?php if($result['img2'] === 1): ?>
<div class="thumbnail"><?= '<img src="../webroot/img/items/thumbnails/' . $result['id'] . 'b.jpg" alt="' .$result['description']. '"/>' ?></div>
<?php endif; ?>
<?php if($result['img3'] === 1): ?>
<div class="thumbnail"><?= '<img src="../webroot/img/items/thumbnails/' . $result['id'] . 'c.jpg" alt="' .$result['description']. '"/>' ?></div>
<?php endif; ?>
<?php if($result['img4'] === 1): ?>
<div class="thumbnail"><?= '<img src="../webroot/img/items/thumbnails/' . $result['id'] . 'd.jpg" alt="' .$result['description']. '"/>' ?></div>
<?php endif; ?>
