                                ...
                                <ul class="nav pull-right " style="margin-right: -10%; margin-top: -5px;">
                                    ...
                                    <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"> Hello Guest <b class="caret"></b> </a>
                                        <ul class="dropdown-menu social-menu">
                                            ...
                                            <!--<li id="account"><a href="account"> My Account (<?//php echo $screen_name, screen_name; ?>)</a></li> -->
                                            <!--<li><?//= $this->Html->link('My Account', ['controller' => 'items', 'action' => 'view', /*put user's id here*/ , 'user is logged in']);?></li> -->
