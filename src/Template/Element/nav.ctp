                            ...
                            <div class="container">
                                ...
                                <div class="nav-collapse">
                                    ...
                                    <ul  class="nav" style="margin-top: -5px;">
                                        <li id="home"><a href="<?= $this->Url->build(['controller' => 'Pages', 'action' => 'display', 'home']) ?>">Home</a></li>
                                        <li id="sell"><a href="<?= $this->Url->build(['controller' => 'Pages', 'action' => 'display', 'sell']) ?>">Sell</a></li>
                                        <li id="contact"><a href="<?= $this->Url->build(['controller' => 'Pages', 'action' => 'display', 'contact']) ?>">Contact</a></li>
                                        <li id="about"><a href="<?= $this->Url->build(['controller' => 'Pages', 'action' => 'display', 'about']) ?>">About</a></li>                    
                                    </ul> 
